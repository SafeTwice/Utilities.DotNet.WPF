...
{
    /// <summary>
    /// Markup extension that checks that a number (or any other comparable object) is equal or greater than the other (A >= B).
    /// </summary>
    public sealed class IsGreaterOrEqual : ComparisonOperationBase<IComparable>
    {
        //===========================================================================
        //                          PUBLIC CONSTRUCTORS
        //===========================================================================
        ...
        /// Default constructor.
        /// </summary>
        public IsGreaterOrEqual() : base( false )
        {
        }
        ...
        public IsGreaterOrEqual( object a, object b ) : base( false )
        {
            A = a;
            B = b;
        }
